...
public class LoginService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["com.example.gwt.shared.LoginResponse/699008517"] = [
        @com.example.gwt.shared.LoginResponse_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.example.gwt.shared.LoginResponse_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/example/gwt/shared/LoginResponse;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.example.gwt.shared.LoginResponse::class)] = "com.example.gwt.shared.LoginResponse/699008517";
